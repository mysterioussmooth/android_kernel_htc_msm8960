...
static struct dsi_cmd_desc novatek_cmd_on_cmds[] = {
	...
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,
		ARRAY_SIZE(novatek_e0), novatek_e0},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,
...
static struct dsi_cmd_desc sony_c1_video_on_cmds[] = {
	...
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, (char[]){0x0A, 0x08}},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, (char[]){0xFB, 0x01}},
...
static struct dsi_cmd_desc auo_panel_video_mode_cmds[] = {
	...
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, (char[]){0x1B, 0x06}},  
...
static void jet_mipi_dsi_set_backlight(struct msm_fb_data_type *mfd)
{
...
static void jet_set_backlight(struct msm_fb_data_type *mfd)
{
	...
	jet_mipi_dsi_set_backlight(mfd);
